...
{
    class ExportReceiptsPoHeaderBlankLines
    {
        public static void CreateShipmentDocument(dc.PurchaseOrderHeader poHeader, dc.CombinedProject proj, int recLines)
        {
            ...
            wdTab1.Cell(3, 3).Range.Text = "Shipping Memo No.";
                //wdTab1.Cell(3, 4).Range.Text = poHeader.MemoNumber.ToString();
            ...
            //wdTab1.Cell(7, 4).Range.Text = poHeader.DateShipped.Value.ToString("dd-MMM-yyyy");
                wdTab1.Cell(7, 4).Range.Text = DateTime.Today.ToString();
            wdTab1.Cell(8, 3).Range.Text = "Required By";
                //wdTab1.Cell(8, 4).Range.Text = poHeader.ReschedShipDate == null ? "" : poHeader.ReschedShipDate.Value.ToString("dd-MMM-yyyy"); // headArr[8, 1].ToString();
            ...
            wdTab2.Cell(8, 2).Range.Text = proj.Rm00101.CustomerName;
            wdTab2.Cell(9, 2).Range.Text = proj.Rm00101.PhoneNumber;
            
            wdTab2.Cell(8, 3).Range.Text = "Ship To:";
            wdTab2.Cell(8, 3).Range.Bold = 1;

            wdTab2.Cell(8, 4).Range.Text = poHeader.JobName;
            wdTab2.Cell(10, 4).Range.Text = proj.Jc00102.AddressCode;
            //wdTab2.Cell(11, 4).Range.Text = poHeader.City + ", " + poHeader.ProvState + ", " + poHeader.PostalZip;
            ...
            wdTab2.Cell(15, 1).Range.Text = poHeader.JobNumber;
            wdTab2.Cell(14, 2).Range.Text = "Shipping Method";
                //wdTab2.Cell(15, 2).Range.Text = poHeader.Courier; // "LOCAL DELIVERY";
            wdTab2.Cell(14, 3).Range.Text = "Attention To";
                //wdTab2.Cell(15, 3).Range.Text = poHeader.Attention;
            wdTab2.Cell(14, 4).Range.Text = "Requested By";
                //wdTab2.Cell(15, 4).Range.Text = poHeader.Shipper;
            wdTab2.Cell(14, 5).Range.Text = "Ship Date";    //ACTUAL ship date field used
                //wdTab2.Cell(15, 5).Range.Text = poHeader.ActualShipDate == null ? "" : poHeader.ActualShipDate.Value.ToString("dd-MMM-yyyy");
            ...
            //wdTab2.Rows[17].Range.Text = poHeader.Comments;
            ...
            //
            wd.Table wdTab6 = wdIn.ActiveDocument.Tables.Add(wdIn.Selection.Range, (recLines * 2) + 1, 4);
                ...
                for (o = 1; o <= wdTab6.Columns.Count; o++)
                {
                    switch (o)
                    {
                        case 1:
                            ...
                            break;
                        case 2:
                            wdTab6.Cell(i + 1, o).Range.InsertAfter("");
                            break;
                        //case 3:
                        ...
                        case 4:
                            ...
                            wdIn.Selection.Cells.Merge();
                            wdTab6.Cell(i + 2, 1).Range.InsertAfter("\t" + "");
