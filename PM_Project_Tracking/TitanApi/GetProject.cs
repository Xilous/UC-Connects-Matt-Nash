...
namespace PM_Project_Tracking.TitanApi
{
    ...
    {
        public static async Task<object> GetProjectById(int projId)
        {
            ...
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    var response = await client.GetAsync("https://ucsh.protechtitan.com/titan/api/customer/projects/" + projId); // _url =api endpoint url
                    if (response != null)
                    {
