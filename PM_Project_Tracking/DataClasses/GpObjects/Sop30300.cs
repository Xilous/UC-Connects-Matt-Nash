...
namespace PM_Project_Tracking.DataClasses.GpObjects
{
    ...
    public class Sop30300 //: INotifyPropertyChanged
    {
        ...
        public Sop30300(string sopNumber, int lineSeq, string itemNumber, string itemDescription, decimal quantityOrdered)
        {
        ...
        public Sop30300(string _docNum, int _lineSeq, int _quant, string _itemNum, string _desc, string locCode, decimal _unitCost, decimal _unitPrice, decimal _extPrice, bool _isNonInv, string lineCom)
        {
